...
#      | IAS Context Control      | Pollution                                                             |
  ...
  @regression @ps
  Scenario Outline: Create a Campaign with 3 Line Items, 3 Tactics each, and 6 Targeting Rules with multiple values per Tactic
    Given This scenario will be executed in the "Demo" environment as a "User"
    And "Life" application is logged in successfully with Account "automation@pulsepoint"
    And User clicks on Create Campaign
    ...
    When User creates line items with tactics and targeting rules as below and assigns existing creative named "<CREATIVE>"
      ...
      | Audio          | Audio_Line | 5000      | Audio_DA_Tactic    | Display Advanced | Behavioral Segment | AutoSegment18577650, 111 > 222 > Patients of HCPs prescribing Ivig and SCIg competitors, AutoSegment414137, AutoSegment747695, AutoSegment772910999                                                    | Geo Targets        | New York, California, Texas, Florida, Illinois, Ohio, Georgia                                                                                                                       | Age                      | 18-24, 25-29, 30-34, 35-39, 40-44, 50-54, 60-64                                                                                 | HCP by Specialty     | Radiology, Aerospace Medicine, Cardiology, Neurology, Oncology, Dermatology, Pediatrics                   | Device              | Mobile, Tablet, Connected Device, Desktop, OOH Device, CTV                                    | Browser         | Chrome, EDGE, Opera, Safari, FireFox                                                        |
      | Audio          | Audio_Line | 5000      | Audio_Email_Tactic | Email            | Email              | AutoEmail120220716113986417, AutoEmail22358729406320, Automation Test 321, TestEmailas12112, Email_FileUpload_20260413_221348, EmailList123Automation                                                  | Health Populations | Electronarcosis, Conscious Sedation, Clinical Enzyme Tests, Microvascular Decompression Surgery                                                                                     | In Condition             | Irritable Bowel Syndrome, Liver Diseases                                                                                        | Legal Populations    | Adoption, Emancipation, Divorce, Separation, Child Custody, Child Support                                 | Keyword Populations | CustomTextForKeywordPopulations, KeywordPopulationsTest, KeywordTestAutomation, Automation123 | Gender          | Male, Female                                                                                |
      | Audio          | Audio_Line | 5000      | Audio_EHR_Tactic   | EHR              | NPI                | AutoSmartList954103283, ATTRIBUTE_20260430_235013, STATIC_NPI_20260430_133910, Auto_Imported_20260426_235032, NPI_LIST_20260514_123551, PRESCRIBED_DRUG_NPI_20250831_132854, SMART_NPI_20251224_190216 | Practice Staff     | SMART_Pixel_NPI_20250701_155147, ATTRIBUTE_20260418_234651, Qwerty Smart List Smart Pixel, NPI_LIST_20260514_123904,                                                                | NPI Facility Affiliation | THE DEVLOPMENT CENTER (WA), THE ACADEMY NORTH INC (MA), INTEGRATED COMMUNITY THERAPISTS LLC (IA), INTUNE MENTAL HEALTH LLC (PA) | Postal Codes         | 10001, 90210, 60601, 77001, 30301, 85001, 94102, 19101                                                    | Health Populations+ | Neuroleptanalgesia, Electroacupuncture, Autonomic Nerve Block, Balanced Anesthesia            | OTC Populations | Antifungals, Suncare, Sleeping Aid, Motion Sickness, Pregnancy, Gastrointestinals, Diabetic |
      | Video          | Video_Line | 8000      | Video_VA_Tactic    | Video Advanced   | Video Size         | Small, Large, Medium                                                                                                                                                                                   | Video Placement    | Interstitial, Accompanying Content, NoContent/Standalone                                                                                                                            | Endemics                 | Endemic Inventory Only                                                                                                          | Brand Safety Profile | 51246802                                                                                                  | Brand Suitability   | Unknown Brand Safety, Highly Illicit Do Not Monetize                                          | Invalid Traffic | Avoid Fraud & IVT Impressions, Avoid Sites/Apps with Historical Fraudulent & IVT Levels     |
      ...
      | Native Display | ND_Line    | 6000      | ND_EHR_Tactic      | EHR              | Sensitive Areas    | Anxiety, Memory Disorders, Anxiety Disorders                                                                                                                                                           | IAB Categories New | Amusement and Theme Parks, Museums & Galleries, Marriage and Civil Unions, Telecommunications Industry                                                                              | Bespoke                  | ABC_Segment_001, Account Assignment, ABCTEST                                                                                    | Keywords             | Custom_Keyword_Test, TestingKeyword123, QwertyTest, MedKeywordCheck, MedKeywordCheck2, HealthKeywordTest1 | Legal Populations   | Adoption, Emancipation, Divorce, Separation, Child Custody, Child Support                     | Geo Radius      | 35.5::122.42::400::California                                                               |
    Then Verify the newly created campaign details in the campaign list: Campaign name, Line item name and Tactic name
    Examples:
      | CREATIVE      |
      | Auto_Creative |

Feature: RTS AdSetup HTTPS Default and Life-Only Endpoint Toggle
  ...
  4. Assumption (Contradicting Requirement Detected, ET-24252): the US East Coast hostname and URL placeholder use ET-24252 own values (ma2-mpc.contextweb.com, URL_ALIAS) as source of truth, not QA-1013 stale lga-mpc/PUBNAME values. See PR body.
